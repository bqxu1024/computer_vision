...
def get_image(path):
    #获取图片
    img = cv2.imread("/home/xbq/xbq/computer_vision/data/VOC2007/JPEGImages/000026.jpg")
...
def Gaussian_Blur(gray):  # 高斯去噪(去除图像中的噪点)
    ...
    高斯矩阵的尺寸和标准差:
    (9, 9)
    表示高斯矩阵的长与宽，标准差取0时OpenCV会根据高斯矩阵的尺寸自己计算。
...
def drawcnts_and_cut(original_img, box):
    #目标图像裁剪 # 因为这个函数有极强的破坏性，所有需要在img.copy()上画
